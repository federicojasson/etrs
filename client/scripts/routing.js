...
(function() {
	...
	function config($stateProvider, $urlRouterProvider) {
		...
		// Defines a regular expression that matches UUIDs (version 4)
		var uuidV4RegularExpression = '[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-4[0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}';
		...
		// State: site.changeEmailAddress
		$stateProvider.state('site.changeEmailAddress', {
			controller: 'RoutingController',
			template: inclusionTemplate,
			url: '/change-email-address'
		}).state('site.changeEmailAddress.anonymous', {
			templateUrl: 'templates/views/log-in.html'
		}).state('site.changeEmailAddress.administrator', {
			templateUrl: 'templates/views/change-email-address.html'
		}).state('site.changeEmailAddress.doctor', {
			templateUrl: 'templates/views/change-email-address.html'
		}).state('site.changeEmailAddress.operator', {
			templateUrl: 'templates/views/change-email-address.html'
		});
		...
		$stateProvider.state('site.createUser', {
			controller: 'RoutingController',
			template: inclusionTemplate,
			url: '/create-user/{id:' + uuidV4RegularExpression + '}/{password:' + uuidV4RegularExpression + '}'
		...
		$stateProvider.state('site.patient', {
			controller: 'RoutingController',
			template: inclusionTemplate,
			url: '/patient/{id:' + uuidV4RegularExpression + '}'
		...
		$stateProvider.state('site.study', {
			controller: 'RoutingController',
			template: inclusionTemplate,
			url: '/study/{id:' + uuidV4RegularExpression + '}'

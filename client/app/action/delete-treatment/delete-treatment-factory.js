...
(function() {
	...
	function DeleteTreatmentActionFactory(dialog, inputValidator, Input, server) {
		 ...
		 * The input.
		 */
		DeleteTreatmentAction.prototype.input;
		
		/**
		 * The start callback.
		 */
		DeleteTreatmentAction.prototype.startCallback;
		
		/**
		 * The success callback.
		 */
		DeleteTreatmentAction.prototype.successCallback;
		
		/**
		 * Initializes an instance of the class.
		 */
		function DeleteTreatmentAction() {
		 ...
		 * Executes the action.
		 */
		DeleteTreatmentAction.prototype.execute = function() {

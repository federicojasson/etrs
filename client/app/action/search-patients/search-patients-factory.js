...
(function() {
	angular.module('app.action.searchPatients').factory('SearchPatientsAction', [
		'inputValidator',
		'Input',
		'server',
		SearchPatientsActionFactory
	]);
	
	/**
	 * Defines the SearchPatientsAction class.
	 */
	function SearchPatientsActionFactory(inputValidator, Input, server) {
		/**
		 * The input.
		 */
		 ...
		 */
		SearchPatientsAction.prototype.successCallback;
		
		/**
		 * Initializes an instance of the class.
		 */
		function SearchPatientsAction() {

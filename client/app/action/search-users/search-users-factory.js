...
(function() {
	angular.module('app.action.searchUsers').factory('SearchUsersAction', [
		'inputValidator',
		'Input',
		'server',
		SearchUsersActionFactory
	]);
	
	/**
	 * Defines the SearchUsersAction class.
	 */
	function SearchUsersActionFactory(inputValidator, Input, server) {
		/**
		 * The input.
		 */
		SearchUsersAction.prototype.input;
		
		/**
		 * The start callback.
		 */
		SearchUsersAction.prototype.startCallback;
		
		/**
		 * The success callback.
		 */
		SearchUsersAction.prototype.successCallback;
		 ...
		 * Executes the action.
		 */
		SearchUsersAction.prototype.execute = function() {

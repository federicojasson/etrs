...
(function() {
	...
	function RequestResetPasswordViewController($scope, RequestResetPasswordAction, dialog, router) {
		...
		function initialize() {
			...
			requestResetPasswordAction.registerNotAuthenticatedCallback(decideName1);
			requestResetPasswordAction.registerStartCallback(decideName2);
			requestResetPasswordAction.registerSuccessCallback(decideName3);

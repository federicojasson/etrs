...
(function() {
	...
	// Controller: CreateConsultationFormController
	module.controller('CreateConsultationFormController', [
		'builder',
		'errorManager',
		'server',
		CreateConsultationFormController
	]);
	
	/*
	 * Controller: CreateConsultationFormController
	 * 
	 * Offers logic functions for the create consultation form.
	 */
	function CreateConsultationFormController(builder, errorManager, server) {
		var controller = this;
		...
		controller.submit = function() {
			...
			server.createConsultation(TODO).then(function(response) {
				// TODO
			}, function(response) {

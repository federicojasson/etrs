...
/*
 * This class encapsulates the logic of an external service and offers
 * specialized methods.
 */
abstract class SpecializedExternalController extends ExternalController {
	...
	/*
	 * Validates a form data input and returns the result.
	 * 
	 * If the input is valid, the file's name and temporary path are set as
	 * entries.
	 * 
	 * It receives the name of the expected input.
	 */
	protected function validateFormDataInput($inputName) {
		$app = $this->app;

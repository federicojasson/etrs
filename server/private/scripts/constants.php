...
define('LOG_LEVEL_ALERT', 'al');
define('LOG_LEVEL_CRITICAL', 'cr');
define('LOG_LEVEL_DEBUG', 'de');
define('LOG_LEVEL_EMERGENCY', 'em');
define('LOG_LEVEL_ERROR', 'er');
define('LOG_LEVEL_INFORMATION', 'in');
define('LOG_LEVEL_NOTICE', 'no');

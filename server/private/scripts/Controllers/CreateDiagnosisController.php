 ...
 *	Method:	POST
 */
class CreateDiagnosisController extends SecureController {
	...
	protected function execute() {
		...
		} while ($businessLogicDatabase->diagnosisExists($id));
		
		// Inserts the diagnosis
		$businessLogicDatabase->insertDiagnosis($id, $creator, $name);

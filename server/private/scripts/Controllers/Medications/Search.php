...
class Search extends \App\Controllers\SecureController {
	...
	protected function call() {
		...
		if (is_null($expression)) {
			...
			$medications = $app->businessLogicDatabase->searchAllNonDeletedMedications($sorting, $limit, $offset);
		} else {
			// Only specific medications should be included in the search
			$medications = $app->businessLogicDatabase->searchSpecificNonDeletedMedications($sorting, $expression, $limit, $offset);
		}

 ...
 *	Method:	POST
 */
class GetConsultationMetadataController extends SecureController {
	...
	protected function execute() {
		...
		$consultation = $app->data->getConsultation($consultationId, ['metadata']);
		...
		// Sets the output
		$app->response->setBody($consultation['metadata']);
	}

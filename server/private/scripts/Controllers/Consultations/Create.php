...
class Create extends \App\Controllers\SecureController {
	...
	protected function call() {
		...
		$app->data->createConsultation($id, $clinicalImpression, $signedInUser['id'], $diagnosis, $signedInUser['id'], $patient, $date, $reasons, $indications, $observations, $backgrounds, $imageTests, $laboratoryTests, $medications, $neurocognitiveTests, $treatments);

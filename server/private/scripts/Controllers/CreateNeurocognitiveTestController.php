 ...
 *	Method:	POST
 */
class CreateNeurocognitiveTestController extends SecureController {
	...
	protected function execute() {
		...
		} while ($businessLogicDatabase->neurocognitiveTestExists($id));
		
		// Inserts the neurocognitive test
		$businessLogicDatabase->insertNeurocognitiveTest($id, $creator, $name, $dataTypeDefinition);

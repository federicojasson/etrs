 ...
 *	Method:	POST
 */
class CreateClinicalImpressionController extends SecureController {
	...
	protected function execute() {
		...
		} while ($businessLogicDatabase->clinicalImpressionExists($id));
		
		// Inserts the clinical impression
		$businessLogicDatabase->insertClinicalImpression($id, $creator, $name);

 ...
 *	Method:	POST
 */
class CreateLaboratoryTestController extends SecureController {
	...
	protected function execute() {
		...
		} while ($businessLogicDatabase->laboratoryTestExists($id));
		
		// Inserts the laboratory test
		$businessLogicDatabase->insertLaboratoryTest($id, $creator, $name, $dataTypeDefinition);

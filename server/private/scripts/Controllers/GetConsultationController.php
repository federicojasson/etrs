 ...
 *	Method:	POST
 */
class GetConsultationController extends SecureController {
	...
	protected function execute() {
		...
		$consultationId = hexadecimalToBinary($input['id']);
		
		// Gets the consultation
		$consultation = $app->data->getConsultation($consultationId);
		...
		$filteredConsultation = $app->dataFilter->filterConsultation($consultation);

 ...
 *	Method:	POST
 */
class CreateMedicationController extends SecureController {
	...
	protected function execute() {
		...
		} while ($businessLogicDatabase->medicationExists($id));
		
		// Inserts the medication
		$businessLogicDatabase->insertMedication($id, $creator, $name);

...
/*
 * This helper manages the account state.
 */
class Account extends \App\Helpers\Helper {
	...
	public function signInUser($id) {
		...
		// Sets a session data entry to store the user
	...
	public function signOutUser() {
		...
		// Clears the session data entry that stores the user

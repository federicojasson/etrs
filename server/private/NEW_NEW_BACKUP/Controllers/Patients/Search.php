...
class Search extends \App\Controllers\SecureController {
	...
	protected function call() {
		...
		if (is_null($expression)) {
			...
			$patients = $app->businessLogicDatabase->searchAllNonDeletedPatients($sorting, $limit, $offset);
		} else {
			// Only specific patients should be included in the search
			$patients = $app->businessLogicDatabase->searchSpecificNonDeletedPatients($sorting, $expression, $limit, $offset);
		}

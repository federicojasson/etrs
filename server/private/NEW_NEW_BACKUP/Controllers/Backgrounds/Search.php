...
class Search extends \App\Controllers\SecureController {
	...
	protected function call() {
		...
		if (is_null($expression)) {
			...
			$backgrounds = $app->businessLogicDatabase->searchAllNonDeletedBackgrounds($sorting, $limit, $offset);
		} else {
			// Only specific backgrounds should be included in the search
			$backgrounds = $app->businessLogicDatabase->searchSpecificNonDeletedBackgrounds($sorting, $expression, $limit, $offset);
		}

...
class Search extends \App\Controllers\SecureController {
	...
	protected function call() {
		...
		if (is_null($expression)) {
			...
			$diagnoses = $app->businessLogicDatabase->searchAllNonDeletedDiagnoses($sorting, $limit, $offset);
		} else {
			// Only specific diagnoses should be included in the search
			$diagnoses = $app->businessLogicDatabase->searchSpecificNonDeletedDiagnoses($sorting, $expression, $limit, $offset);
		}

 ...
 */
class Log extends \App\Data\Entity\Log implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\Data\\Entity\\Log' . "\0" . 'creationDateTime', '' . "\0" . 'App\\Data\\Entity\\Log' . "\0" . 'id', '' . "\0" . 'App\\Data\\Entity\\Log' . "\0" . 'level', '' . "\0" . 'App\\Data\\Entity\\Log' . "\0" . 'message');
        }

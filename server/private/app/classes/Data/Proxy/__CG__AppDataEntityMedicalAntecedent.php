 ...
 */
class MedicalAntecedent extends \App\Data\Entity\MedicalAntecedent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'creationDateTime', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'creator', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'deleted', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'deleter', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'deletionDateTime', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'id', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'lastEditionDateTime', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'lastEditor', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'name', '' . "\0" . 'App\\Data\\Entity\\MedicalAntecedent' . "\0" . 'version');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MedicalAntecedent $proxy) {

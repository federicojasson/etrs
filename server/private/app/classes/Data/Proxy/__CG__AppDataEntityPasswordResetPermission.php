 ...
 */
class PasswordResetPermission extends \App\Data\Entity\PasswordResetPermission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\Data\\Entity\\PasswordResetPermission' . "\0" . 'creationDateTime', '' . "\0" . 'App\\Data\\Entity\\PasswordResetPermission' . "\0" . 'id', '' . "\0" . 'App\\Data\\Entity\\PasswordResetPermission' . "\0" . 'keyStretchingIterations', '' . "\0" . 'App\\Data\\Entity\\PasswordResetPermission' . "\0" . 'passwordHash', '' . "\0" . 'App\\Data\\Entity\\PasswordResetPermission' . "\0" . 'salt', '' . "\0" . 'App\\Data\\Entity\\PasswordResetPermission' . "\0" . 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PasswordResetPermission $proxy) {

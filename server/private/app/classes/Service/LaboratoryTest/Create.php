...
/**
 * Represents the /laboratory-test/create service.
 */
class Create extends \App\Service\External {
	...
	protected function execute() {
		...
		$laboratoryTest = new \App\Data\Entity\LaboratoryTest();
		$laboratoryTest->setDataTypeDefinition($dataTypeDefinition);
		$laboratoryTest->setName($name);
		$laboratoryTest->setCreator($user);
		$app->data->persist($laboratoryTest);
		
		// Gets the laboratory test's ID
		$id = $laboratoryTest->getId();

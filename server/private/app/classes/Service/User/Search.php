...
/**
 * Represents the /user/search service.
 */
class Search extends \App\Service\External {
	...
	protected function execute() {
		...
		if (! is_null($expression)) {
			...
			$queryBuilder
				->andWhere('MATCH(u.emailAddress, u.firstName, u.lastName) AGAINST(:expression BOOLEAN) > 0')
		...
		// Sets an output
		$this->setOutputValue('results', $users, createArrayFilter(function($user) {
			return $user['id'];
		}));

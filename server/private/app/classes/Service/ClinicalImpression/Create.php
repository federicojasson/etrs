...
/**
 * Represents the /clinical-impression/create service.
 */
class Create extends \App\Service\External {
	...
	protected function execute() {
		...
		$clinicalImpression = new \App\Data\Entity\ClinicalImpression();
		$clinicalImpression->setName($name);
		$clinicalImpression->setCreator($user);
		$app->data->persist($clinicalImpression);
		
		// Gets the clinical impression's ID
		$id = $clinicalImpression->getId();

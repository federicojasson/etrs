...
/**
 * Represents the /medical-antecedent/create service.
 */
class Create extends \App\Service\External {
	...
	protected function execute() {
		...
		$medicalAntecedent = new \App\Data\Entity\MedicalAntecedent();
		$medicalAntecedent->setName($name);
		$medicalAntecedent->setCreator($user);
		$app->data->persist($medicalAntecedent);
		
		// Gets the medical antecedent's ID
		$id = $medicalAntecedent->getId();

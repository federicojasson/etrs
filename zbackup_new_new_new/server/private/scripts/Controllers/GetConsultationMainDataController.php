 ...
 *	Method:	POST
 */
class GetConsultationMainDataController extends SecureController {
	...
	protected function execute() {
		...
		$consultation = $app->data->getConsultation($consultationId, ['mainData']);
		...
		// Sets the output
		$app->response->setBody($consultation['mainData']);
	}
